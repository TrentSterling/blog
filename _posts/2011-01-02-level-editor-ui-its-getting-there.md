...
I guess it IS supposed to be geared towards **casual players**, so it's good to have a casual gamer wife to point me in the right direction. I'm also thinking about scrapping the WASD+Mouse for a simpler control style. It would also allow me to make it a 2-player on the same screen sorta game, which me and the wife can really enjoy after setting up [XPadder](http://www.xpadder.com/). Playing flash games with an Xbox 360 controller is pretty fun!

![XPadder](/assets/img/blog/xpadder.png){: .align-center }
*XPadder*
